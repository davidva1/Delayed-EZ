...
class BaseConfig(object):
    ...
    def __init__(self,
        ...
        self.delay = 0
        self.min_delay = 0
        self.test_use_forward = False

        # stats
        self.env_name_short = None
    ...
    def set_config(self, args, env_name_short):
        ...
        if args.stochastic_delay:
            self.min_delay = 0
        else:
            self.min_delay = self.delay

        self.env_name_short = env_name_short
        self.test_use_forward = args.use_forward

        # custom training steps/ transitions
        self.training_steps = args.steps_transitions
        self.total_transitions = args.steps_transitions
        self.start_time = '_'.join(localtime.split())
